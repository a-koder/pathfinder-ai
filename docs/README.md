...
| **Intent Routing** | Root [`README.md`](../README.md) "Intent Routing" section, [`09_Agent_Contracts.md`](09_Agent_Contracts.md) §4 | The five intents (suggest/explore/roadmap/related_topic/general_chat), anchor resolution, why it replaced `_match_previous_choice()` (decisions D034, D037) |
